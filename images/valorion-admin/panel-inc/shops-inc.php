...
?>
				...
				<form action="add-shop.php" method="POST">
					<div class="input-group">
						...
						<span class="input-group-btn">
							<button type="submit" class="btn btn-default"><i class="icon-cart"></i></button>
						</span>
					</div>
				</form>
			</div>
		...
		<div class="block">
			<div class="block full">
				<div class="block-title">
				<h6 class="heading-hr"><i class="icon-file"></i> Search shop</h6>
								</ul>
        	</div>
				...
				while ($resultado = mysql_fetch_assoc($query)) {
					...
					echo "
						<tr>
							...
							<a href='add-shop.php?edit=$id'><i class='icon-pencil2'></i></a>
							</td>
						</tr>
					";
				}
